...
export const WorkExperience = ({ elWorkExp }) => {
  ...
  return (
    <section
      ref={elWorkExp}
      className="relative mt-40 h-fit pt-20 md:px-10 lg:px-20"
    >
      {/* title */}
      <div className="relative h-fit w-full overflow-hidden md:right-10 lg:right-32">
        <h1
      ...
      <div className="mt-14 flex scale-90 flex-col items-center md:mt-0 md:scale-100">
        {/* daido */}
        <div className="relative ml-8 flex w-[90%] flex-col items-center justify-center pt-16 md:ml-16 md:h-[450px] md:flex-row md:gap-x-8 md:pt-0 lg:h-[630px] lg:gap-x-12">
          <div className="absolute -left-1/2 top-1/2 flex h-fit w-fit -rotate-90 items-center pt-5 text-gray-700 dark:text-gray-300 md:-left-56 md:top-1/2 md:pt-0">
        ...
        <div className="relative ml-8 flex w-[90%] flex-col items-center justify-center pt-16 md:ml-16 md:h-[450px] md:flex-row md:gap-x-8 md:pt-0 lg:h-[630px] lg:gap-x-12">
          ...
          <div className="mb-6 flex h-1/2 flex-col items-center justify-between md:mb-0">
            <p className="text-gray-900 dark:text-gray-300">
              Bekasi International Estate Block C11 No 1-5
              <br /> Cikarang Selatan Bekasi 17550 - Indonesia
            </p>
          </div>
          <div className="mb-8 flex w-64 items-center justify-center bg-white shadow-xl shadow-gray-300 dark:shadow-gray-800 md:mb-0 md:h-44 lg:h-64">
